...
//     useEffect(() => {
//         if (players) {
//             socket.emit('requestAuctionDetails', mid);
...
//                                 <div onClick={() => { Bid() }} className='bid-button'>Make Bid</div>
...
function Home() {
    ...
    useEffect(() => {
        // Join a room specific to the player
    ...
    useEffect(() => {
        if (players) {
            // Join a room specific to the auction
